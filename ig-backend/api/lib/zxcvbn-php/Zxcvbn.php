...
require('ScorerInterface.php');
require('Scorer.php');
require('Matcher.php');
require('Searcher.php');
require('Matchers/MatchInterface.php');
require('Matchers/Match.php');
require('Matchers/Bruteforce.php');
require('Matchers/DateMatch.php');
require('Matchers/DictionaryMatch.php');
require('Matchers/DigitMatch.php');
require('Matchers/L33tMatch.php');
require('Matchers/RepeatMatch.php');
require('Matchers/SequenceMatch.php');
require('Matchers/SpatialMatch.php');
require('Matchers/YearMatch.php');
